...
const SalawatFatehaTable = ({ data = [], refresh, showMsg, onEditRow }) => {
    ...
    <AppTheme>
          ...
          <DataGridPro
            rows={useMemo(() => {
              const filteredByType = Array.isArray(data)
                ? data.filter(
                    (row) => String(row.type).toLowerCase() === "salwat" || String(row.type).toLowerCase() === "fateha"
                  )
                : [];
      ...
      >
        {selectedRow?.receipts && 
         ((Array.isArray(selectedRow.receipts) && selectedRow.receipts.length > 0) || 
          ...
          <MenuItem onClick={handlePrintReceipt}>
            <Tooltip title="Print salawat/fateha commitment receipt" placement="left">
        ...
        <MenuItem onClick={handleAddReceipt}>
          <Tooltip
            title="Add new receipt entry for this salawat/fateha"
            placement="left"
          >
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
        ...
        <MenuItem onClick={handleEditCommitment}>
          <Tooltip title="Edit salawat/fateha commitment details" placement="left">
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
        ...
        <MenuItem onClick={handleDeleteClick}>
          <Tooltip title="Delete this salawat/fateha commitment" placement="left">
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
      ...
      <DeleteBookings
        ...
        title="Delete Salawat/Fateha"
        description={`Are you sure you want to delete this Salawat/Fateha${
...
export default SalawatFatehaTable;
