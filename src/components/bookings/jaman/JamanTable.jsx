    ...
    <AppTheme>
      ...
      >
        ...
        <MenuItem onClick={handleAddReceipt}>
          <Tooltip
            title="Add new receipt entry for this extra niyaz in faiz thali"
            placement="left"
          >
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
        ...
        <MenuItem onClick={handleEditCommitment}>
          <Tooltip title="Edit extra niyaz in faiz thali" placement="left">
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
        ...
        <MenuItem onClick={handleDeleteClick}>
          <Tooltip title="Delete this extra niyaz in faiz thali" placement="left">
            <Box display="flex" alignItems="center" gap={1} sx={{ pr: 2 }}>
      ...
      <DeleteBookings
        ...
        title="Delete Extra Niyaz in Faiz Thaali"
        description={`Are you sure you want to delete this extra niyaz in faiz thali${
